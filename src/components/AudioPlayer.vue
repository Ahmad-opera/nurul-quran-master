...
:root{
  --player-bg: #fff;
  --player-border-color: darken(var(--player-bg), 12%);
  --player-link-color: darken(var(--player-bg), 75%);
  --player-progress-color: var(--player-border-color);
  --player-seeker-color: var(--player-link-color);
  --player-text-color: var(--player-link-color);
}
...
.player-controls > div {
		border-right: 1px solid var(--player-border-color);
}
.player-progress {
